...
var JwtInterceptor = /** @class */ (function () {
    ...
    JwtInterceptor.prototype.intercept = function (request, next) {
        if (request.url.startsWith(_app_config__WEBPACK_IMPORTED_MODULE_2__["appConfig"].apiUrl)) {
...
var CustomHttpClient = /** @class */ (function () {
    function CustomHttpClient(http, authService, alertService) {
        var _this = this;
        this.http = http;
        this.authService = authService;
        this.alertService = alertService;
...
/* harmony import */ var _main_content_sample_sample_module__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./main/content/sample/sample.module */ "./src/app/main/content/sample/sample.module.ts");
...
var DocumentsListComponent = /** @class */ (function () {
    ...
    DocumentsListComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            _this.nodeService.node.subscribe(function (node) {
                if (node) {
                    ...
                    _this.nodeService.getNodeDetails(params['id']);
                }
            });
        });
        this.nodeService.userPermissions.subscribe(function (permissions) {
            if (permissions) {
...
var DocumentsService = /** @class */ (function () {
    function DocumentsService(http, authService) {
        ...
        this.docManagementUrl = this.apiUrl + '/document_management_view/';
        this.docCreationUrl = this.apiUrl + '/create_document/';
        this.docDeleteUrl = this.apiUrl + '/delete_document/';
    }
...
/*!*********************************************************!*\
  !*** ./src/app/main/content/sample/sample.component.ts ***!
  \*********************************************************/
/*! exports provided: FuseSampleComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FuseSampleComponent", function() { return FuseSampleComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
/* harmony import */ var _i18n_en__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./i18n/en */ "./src/app/main/content/sample/i18n/en.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var FuseSampleComponent = /** @class */ (function () {
    function FuseSampleComponent(fuseTranslationLoader) {
        this.fuseTranslationLoader = fuseTranslationLoader;
        this.fuseTranslationLoader.loadTranslations(_i18n_en__WEBPACK_IMPORTED_MODULE_2__["locale"]);
    }
    FuseSampleComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'fuse-sample',
            template: __webpack_require__(/*! ./sample.component.html */ "./src/app/main/content/sample/sample.component.html"),
            styles: [__webpack_require__(/*! ./sample.component.scss */ "./src/app/main/content/sample/sample.component.scss")]
        }),
...
/*!******************************************************!*\
  !*** ./src/app/main/content/sample/sample.module.ts ***!
  \******************************************************/
/*! exports provided: FuseSampleModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FuseSampleModule", function() { return FuseSampleModule; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
...
/* harmony import */ var _sample_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./sample.component */ "./src/app/main/content/sample/sample.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        path: 'sample',
        component: _sample_component__WEBPACK_IMPORTED_MODULE_4__["FuseSampleComponent"]
    }
];
var FuseSampleModule = /** @class */ (function () {
    ...
    FuseSampleModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            declarations: [
                _sample_component__WEBPACK_IMPORTED_MODULE_4__["FuseSampleComponent"]
            ],
            imports: [
...
var FuseNavbarComponent = /** @class */ (function () {
    function FuseNavbarComponent(sidebarService, navigationService, router, nodeService, nodeNavigationService, globalService, authService) {
        var _this = this;
        ...
        nodeNavigationService.navigation.subscribe(function (nav) {
            _this.updateNodeNav(nav);
        });
        authService.favoriteNodes.subscribe(function (favoriteNodes) {
            _this.updateFavoriteNodesNav(favoriteNodes);
        });
        // Default layout
        this.layout = 'vertical';
    }
    ...
    FuseNavbarComponent.prototype.updateFavoriteNodesNav = function (favoriteNodes) {
...
var NodeBreadcrumbsComponent = /** @class */ (function () {
    ...
    NodeBreadcrumbsComponent.prototype.ngOnInit = function () {
        ...
        this.nodeService.node.subscribe(function (node) {
            _this.nodeType = node.node_type;
            _this.nodeID = node._id;
            _this._breadcrumbsService.getNodeParents(_this.nodeID)
...
var NodeBreadcrumbsService = /** @class */ (function () {
    ...
    NodeBreadcrumbsService.prototype.getNodeParents = function (nodeID) {
...
var NodeEditComponent = /** @class */ (function () {
    ...
    NodeEditComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.route.params.subscribe(function (params) {
            _this._nodeService.node.subscribe(function (node) {
                if (node) {
                    _this.node = node;
...
var CreateNodeComponent = /** @class */ (function () {
    function CreateNodeComponent(treeStructureHttpService, _tasksService, data) {
    ...
    CreateNodeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_tree_structure_http_service__WEBPACK_IMPORTED_MODULE_1__["TreeStructureHttpService"],
            app_tasks_tasks_service__WEBPACK_IMPORTED_MODULE_3__["TasksService"], Object])
    ], CreateNodeComponent);
        ...
        this.route.params.subscribe(function (params) {
            _this.nodeService.node.subscribe(function (node) {
                if (node !== null) {
                    ...
                    _this.nodeType = node.node_type;
                    _this.nodeID = node._id;
                    _this.authService.favoriteNodes.subscribe(function (favoriteNodes) {
                        _this.favoriteNodeIds = favoriteNodes.map(function (i) { return i._id; });
                        console.log(_this.favoriteNodeIds);
                    });
                }
                else {
                    _this.nodeService.getNodeDetails(params['id']);
...
module.exports = "<div class=\"container\">\n    <div class=\"row valign-wrapper\">\n        <div class=\"col s6 offset-s3 valign\">\n            <div class=\"card darken-1\">\n                <div class=\"card-content\">\n                  <span class=\"card-title\">\n                      register as a new user\n                  </span>\n                  <form class=\"col s12 white\" #userRegistratoinForm=\"ngForm\" (ngSubmit)=\"OnSubmit(userRegistratoinForm)\">\n                      <div class=\"row\">\n                        <div class=\"input-field col s12\">\n                          <input class=\"validate\" type=\"text\" name=\"email\" #email=\"ngModel\" [(ngModel)]=\"user.email\" [pattern]=\"emailPattern\" required>\n                          <label data-error=\"Invalid Email!\">User Email</label>\n                        </div>\n                        <div class=\"input-field col s12\">\n                          <input class=\"validate\" type=\"text\" name=\"email2\" #email=\"ngModel\" [(ngModel)]=\"user.email2\" [pattern]=\"emailPattern\" required>\n                          <label data-error=\"Invalid Email!\">Confirm Email</label>\n                        </div>\n                        <div class=\"input-field col s12\">\n                          <input class=\"validate\" type=\"password\" name=\"password\" #password=\"ngModel\" [(ngModel)]=\"user.password\" required minlength=\"8\">\n                          <label [attr.data-error]=\"password.errors!=null? (password.errors.required?'Required field':'Minimum 8 characters needed'):''\">Password</label>\n                        </div>\n\n                        <div class=\"input-field col s12\">\n                          <input class=\"validate\" type=\"text\" name=\"username\" #username=\"ngModel\" [(ngModel)]=\"user.username\" required minlength=\"4\">\n                          <label [attr.data-error]=\"username.errors!=null? (username.errors.required?'Required field':'Minimum 4 characters needed'):''\">Username</label>\n                        </div>\n\n                        <div class=\"input-field col s12\">\n                          <input type=\"text\" name=\"fullname\" #fullname=\"ngModel\" [(ngModel)]=\"user.fullname\">\n                          <label >Full Name</label>\n                        </div>\n\n                      </div>\n                      <div class=\"row center\">\n                        <div class=\"input-field col s12\">\n                          <button [disabled]=\"!userRegistratoinForm.valid\" class=\"btn-large waves-effect waves-light teal lighten-1 btn-submit\" type=\"submit\">Submit</button>\n                        </div>\n                      </div>\n                  </form>\n        \n        Angular: {{ userRegistratoinForm.value | json }}\n        {{diagnostic}}\n\n          </div>\n        </div>\n    </div>\n  </div>\n</div>\n  <!-- <div *ngIF \"message!==null;then createdMessage\">ignore</div>\n  <ng-template #createdMessage>{{message}} was created</ng-template> -->\n \n"
...
var SignUpComponent = /** @class */ (function () {
    function SignUpComponent(userService, router, alertService) {
        this.userService = userService;
        this.router = router;
        this.alertService = alertService;
...
var UserRoutes = [
    {
        ...
        children: [
            ...
            { path: 'signup', component: _signUp_sign_up_component__WEBPACK_IMPORTED_MODULE_7__["SignUpComponent"] },
...
module.exports = __webpack_require__(/*! G:\Web\vpmoAngular\src\main.ts */"./src/main.ts");
